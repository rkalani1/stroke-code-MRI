...
export default function DecisionSection({ state, updateState }: Props) {
  const onChange = (decision: Exclude<TreatmentDecision, null>) => updateState({ decision });
  ...
  return (
    <div className="border border-[#BCC3CD] rounded-sm mb-4 bg-white shadow-sm">
      ...
      <div className="divide-y divide-[#E5E5E5]">
        ...
        >
          <input type="radio" name="decision" required className="mt-1 shrink-0 w-3.5 h-3.5 text-[#0055CC] focus:ring-[#0055CC]" checked={state.decision === 'thrombolytic'} onChange={() => onChange('thrombolytic')} />
          <div>
        ...
        >
          <input type="radio" name="decision" required className="mt-1 shrink-0 w-3.5 h-3.5 text-[#0055CC] focus:ring-[#0055CC]" checked={state.decision === 'evt'} onChange={() => onChange('evt')} />
          <div>
        ...
        >
          <input type="radio" name="decision" required className="mt-1 shrink-0 w-3.5 h-3.5 text-[#0055CC] focus:ring-[#0055CC]" checked={state.decision === 'both'} onChange={() => onChange('both')} />
          <div>
